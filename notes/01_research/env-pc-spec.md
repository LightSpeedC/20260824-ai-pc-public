...
| 価格 | ゲーミングノート（実売10万円台） | 998,800 円<br>税込・キャンペーン価格<br>定価 2,125,200 円 | — |
| ネットワーク | Wi-Fi 6 AX201（866.7 Mbps） | ConnectX-7 **200GbE** ＋ 10GbE ＋ Wi-Fi 7 | — |

比較対象の HP ZGX Nano G1n の価格・仕様は、日本HP のキャンペーンページと公式スペック表に基づきます。詳細は [GB10搭載AIワークステーション 価格比較調査](gb10-ai-workstation-comparison.md) を参照してください。
